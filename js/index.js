...
lowercaseButton.textContent = "↓";
lowercaseButton.setAttribute("type", "button");
lowercaseButton.setAttribute("data-js", "button-lowercase");
input.parentNode.insertBefore(lowercaseButton, input.nextSibling);
